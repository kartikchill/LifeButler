...
CREATE TABLE "goal" (
    ...
    "consistencyStyle" text,
    "anchorTime" timestamp without time zone,
    "priority" bigint,
    "currentStreak" bigint,
    "longestStreak" bigint,
    "lastEvaluatedPeriodEnd" timestamp without time zone
);

--
-- Class Reflection as table reflection
--
...
--
-- Class TaskCompletion as table task_completion
--
...
--
-- Class UserMode as table user_mode
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('lifebutler', '20260108165059083', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260108165059083', "timestamp" = now();
